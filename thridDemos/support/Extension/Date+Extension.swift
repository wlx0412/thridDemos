...
//        dateFormatter.timeZone = TimeZone(abbreviation: "UTC")
    ...
    //字符串转时间戳
    static func timeStringToInterval(_ dateStr: String) -> TimeInterval {
        let date = DateClass.timeStringToDate(dateStr)
        return date.timeIntervalSince1970
    }
    
    //时间戳转字符串
    static func intervalToDateString(_ time: TimeInterval) -> String{
...
//        dateFormatter.timeZone = TimeZone(abbreviation: "Asia/Shanghai")
    ...
    static func compareCurrentTime(str:String) -> (String, Dictionary<String, Int>) {
        
        let timeDate = self.timeStringToDate(str)
        
        let currentDate = NSDate()
        
        let timeInterval = abs(currentDate.timeIntervalSince(timeDate))
        ...
        if timeInterval/60 < 1 {
            ...
            dict = ["second": Int(timeInterval.truncatingRemainder(dividingBy: 60)), "minute": Int(temp), "hour": 0, "day": 0, "month": 0, "year": 0]
            ...
            let minute = timeInterval.truncatingRemainder(dividingBy: 3600)/60
            dict = ["second": Int(timeInterval.truncatingRemainder(dividingBy: 60)), "minute": Int(minute), "hour": Int(temp), "day": 0, "month": 0, "year": 0]
            ...
            let minute = timeInterval.truncatingRemainder(dividingBy: 3600)/60
            let hour = timeInterval.truncatingRemainder(dividingBy: 86000)/3600
            dict = ["second": Int(timeInterval.truncatingRemainder(dividingBy: 60)), "minute": Int(minute), "hour": Int(hour), "day": Int(temp), "month": 0, "year": 0]
            ...
            let minute = timeInterval.truncatingRemainder(dividingBy: 3600)/60
            let hour = timeInterval.truncatingRemainder(dividingBy: 86000)/3600
            let day = timeInterval.truncatingRemainder(dividingBy: 86000*30)/86000
            dict = ["second": Int(timeInterval.truncatingRemainder(dividingBy: 60)), "minute": Int(minute), "hour": Int(hour), "day": Int(day), "month": Int(temp)]
            ...
            let hour = timeInterval.truncatingRemainder(dividingBy: 86000)/3600
            let day = timeInterval.truncatingRemainder(dividingBy: 86000*30)/86000
            let month = timeInterval.truncatingRemainder(dividingBy: 86000*30*12)/(86000*30)
            dict = ["second": Int(timeInterval.truncatingRemainder(dividingBy: 60)), "minute": Int(minute), "hour": Int(hour), "day": Int(day), "month": Int(month), "year": Int(temp)]
        }

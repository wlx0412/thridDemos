...
class EWPopMenu: NSObject {
    ...
    public func showPopMenuSelecteWithFrameWidth(width: CGFloat, height: CGFloat, point: CGPoint, item: [String], imgSource: [String],_ showNumber: [Bool] = [],action: @escaping ((Int) -> Void)) {
        ...
        menuView?.showNumberLab = showNumber
        self.menuView?.backgroundColor = UIColor.black.withAlphaComponent(0.3)
